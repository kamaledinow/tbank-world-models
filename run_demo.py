...
def main():
    ...
    p.add_argument("--horizon", "--planning-horizon", dest="horizon", type=int, default=8)
    p.add_argument("--num-candidates", "--num_candidates", dest="num_candidates", type=int, default=8)
    args = p.parse_args()
